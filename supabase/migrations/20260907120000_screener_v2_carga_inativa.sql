-- =============================================================
-- SCREENER_IA_V2 — carga INATIVA de SCREENER_IA_V2 2.0.0
--
...
--     Nasce em internal_preview SEM credencial (inerte até semear o hash fora daqui).
